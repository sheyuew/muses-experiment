...
if __name__ == "__main__":
    ...
    if no_args := True:
        if train_from_start := True: 
            ...
            args.eval_only = True
            args.resume = True
            args.opts = ["MODEL.WEIGHTS", "/home/viewegm/models/mask2former_video/trained_models/model_0000199.pth"]
        else:
            args.num_gpus = 1
            args.config_file = "/home/viewegm/video_segmentation/video_segmentation/ship_demo_video/configs/ship_R50.yaml"
            args.resume = True
            args.opts = ["MODEL.WEIGHTS", "/home/viewegm/models/mask2former_video/trained_models/model_00001999.pth"]
