    ...
    for (vid_dict, anno_dict_list) in vids_anns:
        ...
        for frame_idx in range(record["length"]):
            ...
            for anno in anno_dict_list:
                ...
                bbox = _bboxes[frame_idx]  #bbox = [-1, -1, -1, -1]  # Needs bbox value to accept segmentation 
                #if len(_segm) > frame_idx: 
                segm = _segm[frame_idx]  ## TODO: How to accept multiple instances?
                #else:
                #    segm = None
            ...
            camera_objs.append(camera_poses_per_frame)
        record["annotations"] = video_objs
        record["camera_pose"] = camera_objs
